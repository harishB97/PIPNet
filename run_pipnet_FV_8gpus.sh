...
python main.py --log_dir './runs/236-FV_nprotos=10pc-cnext26_PruningBF=1.1NaiveHPIPNetMaskL1=0.5MaskTrainExtra=15epsEps=60Cl=2.0TanhDesc=0.05MinCont=0.1_WeightedCE_with-equalize-aug_img=224' \
               --training_wheels "n" \
               --copy_files "n" \
               --wandb "n" \
               --dataset FV \
               ...
               --num_workers 8 \
               --phylo_config ./configs/fv_fishes_phylogeny.yaml \
               --experiment_note "" \
               --kernel_orth "y" \
               --num_features 0 \
