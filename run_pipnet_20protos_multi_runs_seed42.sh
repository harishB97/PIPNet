...
CUDA_VISIBLE_DEVICES=0,1 MASTER_PORT=29501 TORCH_DISTRIBUTED_DEBUG=DETAIL torchrun --nproc_per_node=2 --master_port=29501 main_dist.py --log_dir './runs/228-178like_repeatation_seed=42_nprotos=20pc-cnext26_PruningBF=1.1NaiveHPIPNetMaskL1=0.5MaskTrainExtra=05epsEps=60Cl=2.0TanhDesc=0.05MinCont=0.1_CUB-190-imgnet-224_WeightedCE_with-equalize-aug_img=224' \
               --training_wheels "n" \
               --copy_files "n" \
               --wandb "n" \
