...
python main.py --log_dir './runs/checking_conc-log-ip-wo-softmax-over-channel-peak-normalize' \
               --training_wheels "n" \
               --copy_files "n" \
               --wandb "n" \
