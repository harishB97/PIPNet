...
source activate hpnet1
which python
# 047-CUB-18-imgnet_OOD_cnext26_img=224_nprotos=5per-desc_tanh-desc
# epoch to 60, pretrain to 10, viz topk commented at all places, print weights commented, prototype purity commented
python main.py --log_dir './runs/047-CUB-18-imgnet_OOD_cnext26_img=224_nprotos=5per-desc_tanh-desc' \
