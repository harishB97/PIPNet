...
# 118-HPIPNetBYOLOpt2ProtopoolProjDist_CUB-18-imgnet-224_with-equalize-aug_cnext26_img=224_nprotos=20_BYOL_no-KO_no-OOD_no-AL_no-TANH
python main.py --log_dir './runs/134-HPIPNetBYOL_bpOnlyCLwClusDesc0.8Topk1Sep0.08_cnext13_CUB-18-imgnet-224_with-equalize-aug_img=224_nprotos=20' \
               --training_wheels "n" \
               --copy_files "y" \
               --wandb "y" \
               ...
               --protopool "n" \
               --stage4_reducer_net "" \
               --state_dict_dir_backbone "/home/harishbabu/projects/PIPNet/runs/checkingBYOLPretraining01-withCS-btau=0.9995to1-60pretrainEpochs/checkpoints/net_pretrained" \
               --basic_cnext_gaussian_multiplier "" \
               --byol 'y' \
               --cluster_desc 'y' \
               --sep_desc 'y' \
               --subspace_sep 'n' \
               --viz_loader 'projectloader,testloader,test_projectloader' \
               --sg_before_protos 'y' \
