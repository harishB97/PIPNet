...
python main.py --log_dir './runs/pretraining-check-010-no-pretraining' \
               --dataset CUB-18-224 \
               --validation_size 0.0 \
