...
# 151-ConciseProtoPNetNoProtoPoolWithKO=0.5WithTanhDesc_Dinov2VitS4_CUB-27-imgnet-224_with-equalize-aug_img=224_nprotos=20
python main.py --log_dir './runs/152-ConciseProtoPNetNoProtoPoolWithKO=0.5WithTanhDescWithAntConc=0.1_Dinov2VitS4_CUB-29-imgnet-224_with-equalize-aug_img=224_nprotos=20' \
               --training_wheels "n" \
               --copy_files "y" \
               --wandb "y" \
               --dataset CUB-29-imgnet-224 \
               --disable_transform2 'y' \
               --validation_size 0.0 \
               --net dinov2_vits14_reg \
               --batch_size 64 \
