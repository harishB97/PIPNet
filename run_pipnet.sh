...
python main.py --log_dir './runs/081-CUB-18-imgnet_with-equalize-aug_cnext26_img=224_nprotos=4per-leaf-desc_unit-sphere_finetune=5_no-meanpool_with-softmax_no-addon-bias_AW=3-TW=2-MMW=2-UW=3-CW=2_mm-loss_batch=56' \
               --dataset CUB-18-imgnet-224 \
               --validation_size 0.0 \
               --net convnext_tiny_26 \
               --batch_size 56 \
               --batch_size_pretrain 56 \
               --epochs 60 \
               --epochs_pretrain 60 \
               --optimizer 'Adam' \
               --lr 0.05 \
