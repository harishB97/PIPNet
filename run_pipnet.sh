...
python main.py --log_dir './runs/210-PruningBF=1.1NaiveHPIPNetMaskL1=0.5MaskTrainExtra=05epsEps=60Cl=2.0TanhDesc=0.05MinCont=0.1_dinov2_CUB-190-imgnet-224_WeightedCE_with-equalize-aug_img=224_nprotos=10pc' \
               --training_wheels "n" \
               --copy_files "y" \
               --wandb "y" \
