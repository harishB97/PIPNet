...
python main.py --log_dir './runs/140-NaiveHPIPNetDisabledTransform2_cnext26_CUB-18-imgnet-224_with-equalize-aug_img=224_nprotos=20' \
               --training_wheels "n" \
               --copy_files "y" \
               --wandb "y" \
