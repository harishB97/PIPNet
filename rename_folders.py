...
def rename_folders(root_dir, prefix='ina'):
    ...
    # Rename each subdirectory - normal to ina format
    ...
    # # Rename each subdirectory - ina to normal format
    # for i, subdir in enumerate(subdirs, start=1):
    #     old_path = os.path.join(root_dir, subdir)
    #     new_name = " ".join(subdir.split('_')[-2:])
...
root_directory = '/projects/ml4science/FishVistaForHCompNet/Max30ImagesPerSpecies/Images/val'
rename_folders(root_directory, prefix='fvi')
